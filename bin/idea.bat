...
SET _JRE_CANDIDATE=
IF "%JRE%" == "" IF EXIST "%APPDATA%\JetBrains\IntelliJIdea2024.3\idea64.exe.jdk" (
  SET /P _JRE_CANDIDATE=<"%APPDATA%\JetBrains\IntelliJIdea2024.3\idea64.exe.jdk"
)
IF "%JRE%" == "" (
...
SET IDE_CACHE_DIR=%LOCALAPPDATA%\JetBrains\IntelliJIdea2024.3
...
IF "%USER_VM_OPTIONS_FILE%" == "" (
  ...
  ) ELSE IF EXIST "%APPDATA%\JetBrains\IntelliJIdea2024.3\idea64.exe.vmoptions" (
    SET "USER_VM_OPTIONS_FILE=%APPDATA%\JetBrains\IntelliJIdea2024.3\idea64.exe.vmoptions"
  )
)
